                ...
                <div className="container mx-auto px-6 h-20 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-8">
                        <nav className="hidden md:flex items-center gap-8 text-xs font-bold uppercase tracking-widest text-muted-foreground">
                            ...
                            <Link href="/#donate" className="hover:text-primary transition-colors text-emerald-500">
                                Donate
                            </Link>
                        </nav>
                    ...
                    {menuOpen && (
                        ...
                        >
                            <nav className="flex flex-col gap-6 text-xl font-serif font-bold">
                                ...
                                <Link href="/#donate" onClick={() => setMenuOpen(false)} className="text-emerald-500">Donate</Link>
