...
import { Chrome, MoveRight, Loader2, ArrowLeft } from "lucide-react"
            ...
            >
                ...
                <div className="p-8 md:p-12 flex flex-col justify-center">
                    ...
                    <button
                        ...
                        className="w-full h-12 rounded-lg border font-semibold flex items-center justify-center gap-3 hover:bg-accent transition mb-6"
                    >
                    ...
                    <form onSubmit={handleCredentialsLogin} className="space-y-4">
                        ...
                        >
                            {isLoading ? <Loader2 className="animate-spin" /> : <>Login <MoveRight size={16} /></>}
                        </button>
                    </form>
